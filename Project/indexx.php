...
<body>
  ...
  <div id="myDropdown" class="dropdown-content">
	...
	<!-- Effective+Welcome -->
    <div class="site-blocks-cover" style="background-image: url('images/majhar.jpg');">
      <div class="container">
        <div class="row">
          <div class="col-lg-7 mx-auto order-lg-2 align-self-center">
            <div class="site-block-cover-content text-center">
              <h2 class="sub-title">Hi Everybody</h2>
              <h1>Welcome To SEE5</h1>
	<!-- Effective+Welcome -->
      ...
      <div class="container">
        <div class="row">
          <div class="title-section text-center col-12">
            <h2 class="text-uppercase">Website Creators</h2>
          </div>
        </div>
        ...
        <?php
            ...
            $sql = "SELECT * FROM `about` WHERE rank='student'";//query
            $result = $conn->query($sql);//send query
            if ($result->num_rows > 0) //there is data
			{
                while($row = $result->fetch_assoc())//print all data
				{
				echo "  <div class='testimony'>";
                echo "<blockquote>";
                echo " <img src='images/about_us/$row[id].jpg' alt='$row[name]' class='img-fluid w-25 mb-4 rounded-circle'>";
                echo " <p>&ldquo;$row[about]&rdquo;</p>";
				echo "  </blockquote>";
				echo " <p>&mdash; $row[name]</p>";
				echo " </div>";
                }
			}
        ?>
